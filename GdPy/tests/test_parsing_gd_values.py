...
def test_GdValueNodePath():
    assert(gdparser.transformer.matcher(None, "nodepath"))
...
def test_GdValueSubResource():
    assert(gdparser.transformer.matcher(None, "subresource"))
...
def test_GdValueStringName():
    assert(gdparser.transformer.matcher(None, "STRINGNAME"))
    assert(isinstance(_run("value", '&"value"'), GdValueStringName))
    # assert(_run("value", '&"va) ==e()"') GdValueStringName))

def test_GdValueDictionary():
    assert(gdparser.transformer.matcher(None, "dictionary"))
    assert(gdparser.transformer.matcher(None, "dictionary_explicit"))
...
def test_GdValueArray():
    assert(gdparser.transformer.matcher(None,  "array"))
...
def test_GdValueVector2():
    assert(gdparser.transformer.matcher(None,  "vector2"))
...
def test_GdValueVector3():
    assert(gdparser.transformer.matcher(None,  "vector3"))
...
def test_GdValueVector4():
    assert(gdparser.transformer.matcher(None,  "vector4"))
...
def test_GdValueVector2i():
    assert(gdparser.transformer.matcher(None,  "vector2i"))
...
def test_GdValueVector3i():
    assert(gdparser.transformer.matcher(None,  "vector3i"))
...
def test_GdValueVector4i():
    assert(gdparser.transformer.matcher(None,  "vector4i"))
...
def test_GdValueRect2():
    assert(gdparser.transformer.matcher(None,  "rect2"))
...
def test_GdValueRect2i():
    assert(gdparser.transformer.matcher(None,  "rect2i"))
...
def test_GdValuePlane():
    assert(gdparser.transformer.matcher(None,  "plane"))
...
def test_GdValueColor():
    assert(gdparser.transformer.matcher(None,  "color"))
...
def test_GdValueAABB():
    assert(gdparser.transformer.matcher(None,  "aabb"))
...
def test_GdValueQuaternion():
    assert(gdparser.transformer.matcher(None,  "quaternion"))
...
def test_GdValueBasis():
    assert(gdparser.transformer.matcher(None,  "basis"))
...
def test_GdValueTransform2D():
    assert(gdparser.transformer.matcher(None,  "transform2d"))
...
def test_GdValueTransform3D():
    assert(gdparser.transformer.matcher(None,  "transform3d"))
...
def test_GdValuePackedByteArray():
    assert(gdparser.transformer.matcher(None,  "packedbytearray"))
...
def test_GdValuePackedInt32Array():
    assert(gdparser.transformer.matcher(None,  "packedint32array"))
...
def test_GdValuePackedInt64Array():
    assert(gdparser.transformer.matcher(None,  "packedint64array"))
...
def test_GdValuePackedFloat32Array():
    assert(gdparser.transformer.matcher(None,  "packedfloat32array"))
...
def test_GdValuePackedFloat64Array():
    assert(gdparser.transformer.matcher(None,  "packedfloat64array"))
...
def test_GdValuePackedStringArray():
    assert(gdparser.transformer.matcher(None,  "packedstringarray"))
...
def test_GdValuePackedVector2Array():
    assert(gdparser.transformer.matcher(None,  "packedvector2array"))
...
def test_GdValuePackedVector3Array():
    assert(gdparser.transformer.matcher(None,  "packedvector3array"))
...
def test_GdValuePackedVector4Array():
    assert(gdparser.transformer.matcher(None,  "packedvector4array"))
...
def test_GdValuePackedColorArray():
    assert(gdparser.transformer.matcher(None,  "packedcolorarra)" ))

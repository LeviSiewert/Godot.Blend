...
from .lark_transformer import LarkTransformerModuleCentralized, LarkTransformerModuleTerminals, LarkTransformerRuleset
from .transformer_v2 import Transformer

class GdParser():
    def __init__(self, grammer:str, types:Iterable[Type]):
        self.grammer = grammer
        self.transformer = Transformer([
            LarkTransformerRuleset([
                LarkTransformerModuleTerminals(),
                LarkTransformerModuleCentralized(types)
            ]),
        ])

...
class Test_Dictionary():
    class Test_Explicit(_StructureTest):
        _type = Dictionary
        _parser_key = "explicit_dict"
        def data_to_py_only(self,session):
